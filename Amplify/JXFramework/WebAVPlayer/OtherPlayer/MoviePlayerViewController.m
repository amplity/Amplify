...
- (void)createSlider
{
    ...
    UISlider* slider = [[UISlider alloc] initWithFrame:CGRectMake(100, _height-36, _width * 0.7, 15)];
    self.slider = slider;
    ...
    _slider.minimumTrackTintColor = [UIColor colorWithRed:182 / 255.0 green:161 / 255.0 blue:140 / 255.0 alpha:1];
    
    _slider.minimumTrackTintColor = HexRGB(0x252525);
    _slider.maximumTrackTintColor = HexRGB(0x252525);
    [_slider setThumbTintColor:HexRGB(0x252525)];
}
...
- (void)createProgress
{
    UIProgressView* progress = [[UIProgressView alloc] initWithFrame:CGRectMake(102, _height-30, _width * 0.69, 15)];
    self.progress = progress;
    [_backView addSubview:_progress];
    
    
    progress.tintColor =HexRGB(0x252525);
...
{
    UILabel* currentTimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(_width * 0.86, _height-40, 100, 20)];
...
//    UIEdgeInsets padding = UIEdgeInsetsMake(10, _width * 0.86, 30, 10);
//    [_currentTimeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.bottom.equalTo(_backView.mas_bottom).with.offset(-padding.bottom);
//        make.left.equalTo(_backView.mas_left).with.offset(padding.left);
//    }];
}
#pragma mark - 计时器事件
- (void)Stack
...
- (void)createButton
{
    ...
    startButton.frame = CGRectMake(15, _height-45, 30, 30);
    ...
    nextButton.frame = CGRectMake(60, _height-42, 25, 25);
...
//    UIEdgeInsets padding = UIEdgeInsetsMake(10, 15, 30, 10);
//    [startButton mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.bottom.equalTo(_backView.mas_bottom).with.offset(-padding.bottom);
//    }];
//    
//    UIEdgeInsets nextButtonPadding = UIEdgeInsetsMake(10, 60, 30, 10);
//    [nextButton mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.bottom.equalTo(_backView.mas_bottom).with.offset(-nextButtonPadding.bottom);
//        make.left.equalTo(_backView.mas_left).with.offset(nextButtonPadding.left);
//    }];
}
...
- (void)createTitle
{
    ...
    UILabel* titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(_width/2-250/2, 10, 250, 30)];
...
//覆盖view controller的prefersStatusBarHidden的实现，返会YES。
